...
var file_object_grpc_service_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x32, 0xb2, 0x04, 0x0a, 0x0d, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x53, 0x65, 0x72,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x5b, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_object_grpc_service_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
...
func file_object_grpc_service_proto_init() {
	...
	file_object_grpc_service_proto_msgTypes[17].OneofWrappers = []interface{}{
	...
	file_object_grpc_service_proto_msgTypes[25].OneofWrappers = []interface{}{
		(*HeadResponse_Body_Header)(nil),
		(*HeadResponse_Body_ShortHeader)(nil),
		(*HeadResponse_Body_SplitInfo)(nil),
	}
	file_object_grpc_service_proto_msgTypes[30].OneofWrappers = []interface{}{
